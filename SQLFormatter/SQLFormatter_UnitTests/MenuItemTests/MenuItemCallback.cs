...
using RobEllis.SQLFormatter;

namespace SQLFormatter_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SQLFormatterPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(RobEllis.SQLFormatter.GuidList.guidSQLFormatterCmdSet, (int)RobEllis.SQLFormatter.PkgCmdIDList.cmdIdFormatSql);
