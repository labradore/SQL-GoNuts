...
namespace SQLFormatter_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(RobEllis.SQLFormatter.GuidList.guidSQLFormatterCmdSet, (int)RobEllis.SQLFormatter.PkgCmdIDList.cmdIdFormatSql);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "SQLFormatter", "RobEllis.SQLFormatter.SQLFormatterPackage");
